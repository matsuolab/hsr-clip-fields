...
class DataCollector:
    ...
    def __init__(self):
        ...
        # service
        self.start_service = rospy.Service("/save_data/start", Empty, self.start_callback)
        self.stop_service = rospy.Service("/save_data/stop", Empty, self.stop_callback)
    ...
    def main(self):
        ...
        if not os.path.isdir("/root/catkin_ws/src/ros_docker/hsr_collection/scripts/hsr-clip-fields/data/" + TAG):
