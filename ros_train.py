...
class ClipFieldsTrainer:
    def __init__(self, trained_model_path:str=None) -> None:
        rospy.init_node('clip_fields_trainer', anonymous=True)
        ...
        # service
        rospy.Service('clip_fields_trainer', Empty, self.trainer_srv)

        #service proxy
        self.finish_training = rospy.ServiceProxy('finish_training', Empty)
